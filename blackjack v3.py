...
print("Your goal: get 10,000 stack. Now your stack is 1000")
print("Let's begin")
...
while 0<player.stack<10000:
    ...
    while True and ochkogamer<=21:
        ...
        if ans=="YES" or ans == "Y":
            ...
            anw = anw.upper()
            if (anw == "YES" or anw == "Y") and player.stack>0:
                n = int(input("How much?"))
                player.bet(n)
                bank += n * 2
            print("Bank is", bank)
    ...
    if (ochkogamer<=21 and ochkogamer>ochkodiler) or ochkodiler>21:
        ...
        print("I win")
        print("You have " + str(ochkogamer) +" points.I have "+str(ochkodiler) + " points.")
    print("Your stuck is", player.stack)
    input("Now we try again")
if player.stack<=0:
    print("Lose. Stack is", player.stack)
else:
    print("GREAT. Stuck is", player.stack)
input()
